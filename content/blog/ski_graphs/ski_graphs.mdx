...
This prompted me to make a little widget that would find shortest paths between two points in the resort. The result
...
<ExpandableCodeBlockMulti filePaths={["ski_graphs/ski_graph.jsx", "js/graphs.js"]} />
