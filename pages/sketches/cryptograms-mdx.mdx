...
import styles from '../../styles/sketches/cryptograms.module.scss';
...
<div class={styles.cryptogram}><p>APPF VIBQ KMF EKLC DIM!</p></div>

You can try solving it for yourself, or you can hover over the solution below.

<div class={styles.solution}><p>GOOD LUCK AND HAVE FUN!</p></div>

The cipher (a map from encoded to decoded characters) is what the program solves for.
...
<div class={styles.cryptogram}><p>APPF VIBQ KMF EKLC DIM!</p></div>
<div class={styles.cryptogram}><p>-OOD ---- --D ---- ---!</p></div>
...
<div class={styles.cryptogram}><p>X WK DBKZ KBF NRXBM HYKTN CF: X WKB'N CFHVTQF CJVFPA YJ KNRFQV' FEUFONHNXKBV KQ PFN KNRFQV WFAXBF CJ ZKQNR.</p></div>

<div class={styles.solution}><p>I do know one thing about me: I don't measure myself by others' expectations or let others define my worth.</p></div>
...
<div class={styles.cryptogram}><p>G NQPBSDKBDX TUN BDQLNR XQ NUPB VQL BPBSVXRUDN VQL FGDX UJ G NQPBSDKBDX TUN BDQLNR XQ XGHB YSQK VQL BPBSVXRUDN VQL RGPB</p></div>
<div class={styles.solution}><p>A government big enough to give you everything you want is a government big enough to take from you everything you have.</p></div>
